...
from utils.client_manager import ClientManager, Client
...
class ProjectsView(ft.View):
                ...
                controls=[
                    ft.Column(
                        controls=[
                            ...
                            ft.Text(f"Cliente: {project.client}", style=ft.TextThemeStyle.BODY_MEDIUM),
    ...
    def show_create_project_dialog(self, e):
        ...
        def create_project(e):
            try:
                ...
                project.client = client_name_field.value
    ...
    def show_project_details(self, project):
        ...
        confirm_dialog = ft.AlertDialog(
            ...
            content=ft.Column([
                ft.Text(f"Cliente: {project.client}"),
    ...
    def show_edit_project_dialog(self, project):
        ...
        client_name_field = ft.TextField(label="Nombre del Cliente", value=project.client)
        ...
        def update_project(e):
            try:
                ...
                self.project_manager.update_project(
                    project.id,
                    name=name_field.value,
                    client=client_name_field.value,
                    description=description_field.value or "",
                    budget=budget,
